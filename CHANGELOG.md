...
- Los 41 cursos pasan de módulos documentales a **451 clases trazables** (11 por
  ...
  resultados, actividad, evidencia, criterio de aprobación y fuentes. Los datos
  administrativos quedan ocultos al lector y la lección visible incorpora una
  pregunta guía, explicación causal, caso resuelto y comprobación basada en el
  sistema, principio, riesgo y decisión propios de cada máquina.
...
- Modelo pedagógico, plantilla de clase, rúbrica base y registros de fuentes por
  ...
  secuencia, duración, guía aplicada, caso resuelto, cierre evaluable y fuentes
  visibles.
...
- Módulo 11 de cada curso: **🎯 Ejercicios y autoevaluación**, con preguntas de repaso, casos de operación y ejercicios de diseño de simulación. Las respuestas van plegadas para que el intento preceda a la lectura, y cada una enlaza al módulo que la cubre. En las naves de ficción la sección 2 pide separar la física real de la licencia creativa, en vez de plantear casos de operación. El validador exige las nuevas secciones `modelos/` y `ejercicios/` en los 41 cursos.
