...
codigo: DELOREAN-01
curso: delorean
titulo: "Historia de la DeLorean temporal"
...
resultados_aprendizaje:
  - "Explicar origen, evolución tecnológica, variantes representativas e impacto con vocabulario propio de DeLorean temporal."
...
```mermaid
timeline
    title Contexto divulgativo de la nave temporal
    Idea : Un coche comun imaginado como maquina del tiempo
    Umbral : Se populariza la nocion de una velocidad umbral magica
    Energia : La historia asocia el salto a una fuente de gran energia
    Cultura : La nave se vuelve simbolo del viaje en el tiempo
    Hoy : Se usa como caso de estudio de fisica en aulas y divulgacion
```
...
- **Actividad:** Construye una línea de tiempo de DeLorean temporal y explica cómo dos cambios históricos transformaron su función o su puesto de mando.
- **Evidencia:** Línea de tiempo comentada con cuatro hitos o más.
