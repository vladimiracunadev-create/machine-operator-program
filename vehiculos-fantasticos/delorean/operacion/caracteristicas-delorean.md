...
```mermaid
flowchart TD
    Nave[🕰️ DeLorean temporal] --> Carretera[Modo carretera normal]
    Nave --> Salto[Modo salto temporal ficticio]
    Carretera --> Reglas1[Obedece la física real]
    Carretera --> Uso1[Acelerar, frenar, girar]
    Salto --> Reglas2[Rompe la física por narrativa]
    Salto --> Uso2[Fijar fecha y ejecutar salto]
    Salto --> Riesgo[Posible paradoja causal]
```
