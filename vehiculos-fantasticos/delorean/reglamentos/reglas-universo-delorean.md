...
```mermaid
flowchart TD
    Reglas[Reglas internas de la ficción] --> Modo[Se activan en modo ficción]
    Modo --> Sim[Se modelan en el simulador]
    Sim --> Debate[Abren el debate sobre causalidad]
    Debate --> Ciencia[Se contrastan con la física real]
```
