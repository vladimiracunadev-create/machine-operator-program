...
¿Cómo ayuda **Objetivo de la simulación, Modo ciencia o ficción, Variables principales y Ciclo básico** a **modelar falla simulada de distribución que afecta sectores distintos como estados, variables y decisiones observables**?

### Explicación razonada

Una simulación de Estrella de la Muerte es educativa si representa decisiones y consecuencias. Como mínimo debe modelar el estado de reactor ficticio, la respuesta de distribución, la transición en propulsión y control y el resultado en estación. El escenario «falla simulada de distribución que afecta sectores distintos» es valioso porque obliga a observar, formular una hipótesis, actuar y comprobar.
...
1. **Estado inicial:** representa falla simulada de distribución que afecta sectores distintos con valores observables para **reactor ficticio**, **distribución**, **propulsión y control** y **estación**.
2. **Decisión del estudiante:** ofrece una elección que cambie el estado, no una animación automática.
3. **Consecuencia:** modela la tendencia hacia **crear un sistema invulnerable o sin propagación comprensible de fallas** y una señal previa que permita corregir.
4. **Cierre:** evalúa la explicación de la decisión, además de si el estudiante “ganó” el escenario.

### Comprueba tu comprensión

1. ¿Qué cuatro estados mínimos necesita el escenario «falla simulada de distribución que afecta sectores distintos»?
2. ¿Qué variable anticipa **crear un sistema invulnerable o sin propagación comprensible de fallas** antes de llegar al estado de falla?
