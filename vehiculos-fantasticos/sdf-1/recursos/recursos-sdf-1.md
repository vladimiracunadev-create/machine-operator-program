...
```mermaid
flowchart LR
    Crecer[Agrandar la nave] --> Sup[Superficie al cuadrado]
    Crecer --> Vol[Volumen al cubo]
    Vol --> Masa[Masa enorme]
    Sup --> Limite[Menos aguante y menos disipación relativos]
    Masa --> Limite
    Limite --> Idea[Por eso los gigantes son un reto de ingeniería]
```
...
[🎓 Portada del curso](../README.md) · [⬅️ Anterior: Diseño de simulación](../simulacion/diseno-simulador-sdf-1.md)
