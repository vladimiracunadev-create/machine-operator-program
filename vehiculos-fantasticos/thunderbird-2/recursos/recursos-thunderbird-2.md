...
```mermaid
flowchart LR
    Estructura[Más estructura] --> Peso[Sube el peso propio]
    Peso --> Menos[Queda menos carga útil]
    Carga[Añadir módulo] --> Total[Sube el peso total]
    Total --> Empuje[Baja el margen de empuje]
    Menos --> Idea[El diseño busca el equilibrio]
    Empuje --> Idea
```
...
[🎓 Portada del curso](../README.md) · [⬅️ Anterior: Diseño de simulación](../simulacion/diseno-simulador-thunderbird-2.md) · [➡️ Siguiente: Ejercicios](../ejercicios/ejercicios-thunderbird-2.md)
