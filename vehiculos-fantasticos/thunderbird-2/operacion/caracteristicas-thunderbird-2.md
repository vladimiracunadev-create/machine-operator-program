...
```mermaid
flowchart TD
    Transporte[📦 Transporte modular] --> Ligero[Portador ligero]
    Transporte --> Pesado[Portador pesado]
    Transporte --> Especial[Módulo especializado]
    Ligero --> Agil[Prioriza rapidez y poca carga]
    Pesado --> Masa[Más estructura y más carga útil]
    Especial --> Mision[Un módulo por tipo de misión]
```
...
[⬅️ Anterior: Historia](../historia/historia-thunderbird-2.md) · [➡️ Siguiente: Modelos y variantes](../modelos/modelos-thunderbird-2.md)
