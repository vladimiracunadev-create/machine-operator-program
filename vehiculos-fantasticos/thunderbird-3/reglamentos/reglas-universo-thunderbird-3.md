...
curso: thunderbird-3
titulo: "Reglas del universo del Thunderbird 3"
modalidad: "estudio de casos"
duracion_minutos: 60
nivel: introductorio
prerrequisito: THUNDERBIRD3-07
competencia: "cumplimiento_y_seguridad"
resultados_aprendizaje:
  - "Explicar ámbito, requisitos, seguridad, restricciones y aplicación en simulación con vocabulario propio de Thunderbird 3."
...
[🏠 Inicio](../../../README.md) · [🚀 Curso: Thunderbird 3](../README.md) · ⚖️ Reglas del universo
...
Son acuerdos narrativos: la ficción establece como despegan y vuelven los cohetes
para que el relato sea emocionante y fácil de seguir. Son coherentes dentro de la
...
| --- | --- | --- |
| El cohete despega en segundos | Urgencia y espectáculo inmediato | El ascenso dura minutos y exige mucho propelente. |
| Basta con subir muy alto | Meta clara y fácil de contar | Sin velocidad lateral se vuelve a caer. |
| El cohete sube y baja entero | Simplifica la acción | Conviene soltar etapas vacías por el camino. |
| El combustible casi no cuenta | No interrumpe el rescate | El propelente es casi toda la masa del cohete. |
| Aterriza suave al instante | Final limpio y heroico | La reentrada libera enorme energía y calor. |
| Sube siempre recto | Imagen sencilla del cohete | Hay que inclinar para ganar velocidad lateral. |
...
mandan la gravedad, la resistencia del aire y la ecuación del cohete, que hace
crecer el combustible de forma exponencial con el delta-v deseado. Cuando el
...
- **Actividad:** Analiza dos casos de Thunderbird 3; localiza la fuente aplicable y separa obligación real, buena práctica y regla de simulación.
- **Evidencia:** Ficha normativa con decisión y fuente trazable.
...
[⬅️ Anterior: Entornos](../operacion/entornos-thunderbird-3.md) · [➡️ Siguiente: Diseño de simulación](../simulacion/diseno-simulador-thunderbird-3.md)
