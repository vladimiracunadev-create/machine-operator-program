...
clase: 2
codigo: THUNDERBIRD1-02
curso: thunderbird-1
titulo: "Características de Thunderbird 1"
modalidad: "teórica aplicada"
duracion_minutos: 45
nivel: introductorio
prerrequisito: THUNDERBIRD1-01
competencia: "identificacion_funcional"
resultados_aprendizaje:
  - "Explicar definición, rasgos funcionales, tipos y usos con vocabulario propio de Thunderbird 1."
...
```mermaid
flowchart TD
    Nave[⚡ Vehículo de respuesta rápida] --> Ligero[Explorador ligero]
    Nave --> Pesado[Transporte pesado]
    Nave --> Mixto[Nave de transición]
    Ligero --> Agil[Prioriza velocidad y despegue rápido]
    Pesado --> Carga[Más empuje para más peso]
    Mixto --> Equilibrio[Equilibra VTOL y crucero]
```
...
- **Actividad:** Compara variantes de Thunderbird 1 mediante los ejes «definición, rasgos funcionales, tipos y usos» y elige una para un caso de uso razonado.
- **Evidencia:** Matriz comparativa y decisión justificada.
