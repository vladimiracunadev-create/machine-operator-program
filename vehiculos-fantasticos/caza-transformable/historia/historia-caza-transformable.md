...
titulo: "Historia del caza transformable"
...
resultados_aprendizaje:
  - "Explicar origen, evolución tecnológica, variantes representativas e impacto con vocabulario propio de Caza transformable."
...
```mermaid
timeline
    title Evolucion del concepto de caza transformable
    Anos 60 : Primeros robots gigantes pilotados en pantalla
    Anos 70 : Vehiculos que se combinan y separan
    Anos 80 : Auge del caza que muta entre avion y robot estilo Robotech
    Anos 90 : Refinamiento del diseno y del intermedio articulado
    Anos 2000 : Modelado digital de transformaciones complejas
    Hoy : Fandom, ingenieria inversa amateur y estudios de viabilidad
```
...
- **Actividad:** Construye una línea de tiempo de Caza transformable y explica cómo dos cambios históricos transformaron su función o su puesto de mando.
- **Evidencia:** Línea de tiempo comentada con cuatro hitos o más.
