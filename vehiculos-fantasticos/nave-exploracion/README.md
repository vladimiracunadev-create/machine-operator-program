...
```mermaid
flowchart TD
    Luz[Límite de la luz c] --> Distancias[Distancias en años luz]
    Distancias --> Tiempo[Dilatación temporal]
    Tiempo --> Energia[Problema energético]
    Energia --> Generacional[Naves generacionales lentas]
    Energia --> Warp[Impulso superluminico teórico]
    Warp --> Alcubierre[Métrica de Alcubierre]
    Alcubierre --> Causalidad[Ruptura de causalidad]
    Generacional --> Sim[Simulación educativa]
    Causalidad --> Sim
```
