...
flowchart TD
    ...
    Propulsion --> Superluminico[Impulso superluminico imaginario]
    Energia --> Reactor[Reactor de alta potencia]
    Habitat --> Vivienda[Vivienda y ocio]
    Habitat --> Laboratorio[Laboratorios]
```
