...
titulo: "Historia de la nave de exploración"
...
resultados_aprendizaje:
  - "Explicar origen, evolución tecnológica, variantes representativas e impacto con vocabulario propio de Nave de exploración."
...
```mermaid
timeline
    title Como la ficcion imagino el viaje interestelar
    1865 : Primeros relatos de viajes a otros mundos
    1900-1930 : Cohetes y ciencia del espacio en la imaginacion popular
    1940-1950 : Naves con motores de fantasia y saltos entre estrellas
    1960-1970 : La nave de exploracion como hogar y laboratorio
    1980-2000 : Efectos visuales dan forma a flotas y motores imaginarios
    2000-hoy : Fisica real inspira ideas como la metrica de Alcubierre
```
...
- **Actividad:** Construye una línea de tiempo de Nave de exploración y explica cómo dos cambios históricos transformaron su función o su puesto de mando.
- **Evidencia:** Línea de tiempo comentada con cuatro hitos o más.
