...
titulo: "Historia del teletransportador"
...
resultados_aprendizaje:
  - "Explicar origen, evolución tecnológica, variantes representativas e impacto con vocabulario propio de Teletransportador."
...
```mermaid
timeline
    title Idea del teletransporte e historia de la fisica real
    Antiguedad : Mitos de aparecer y desaparecer al instante
    1900-1930 : La equivalencia masa-energia da escala al problema
    1930-1950 : Nace la teoria de la informacion y el bit
    1960-1980 : La ficcion populariza la maquina de teletransporte
    1980-1995 : Se enuncia el teorema de no clonacion cuantica
    1990-2000 : Se describe la teleportacion cuantica de estados
    2000-hoy : Experimentos transfieren estados, no objetos ni materia
```
