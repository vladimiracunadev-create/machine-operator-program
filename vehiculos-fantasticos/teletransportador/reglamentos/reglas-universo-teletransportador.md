...
En la ficción, un aparato no obedece la física real sino las "reglas internas"
que la obra decide para que la historia funcione. Este módulo describe con
nuestras palabras esas convenciones del teletransporte genérico y, junto a cada
...
Son acuerdos narrativos: la ficción establece como aparece y desaparece la gente
para que el relato sea ágil y cómodo de seguir. Son coherentes dentro de la
...
[⬅️ Anterior: Entornos](../operacion/entornos-teletransportador.md) · [➡️ Siguiente: Diseño de simulación](../simulacion/diseno-simulador-teletransportador.md)
