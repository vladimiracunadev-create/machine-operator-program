...
| 3 | 🧩 Modelos y variantes | Que cambia entre modelos: manejo, mando y simulador. | [Abrir](modelos/modelos-tanque.md) |
| 4 | 🔧 Sistemas mecánicos | Tren de rodaje de orugas, suspensión, motor y movilidad. | [Abrir](operacion/sistemas-mecanicos-tanque.md) |
| 5 | 🎛️ Mandos e instrumentos | Puesto del conductor a nivel general educativo. | [Abrir](mandos/manual-mandos-tanque.md) |
| 6 | 🧪 Principios y operación | Física de la movilidad y fases generales. | [Abrir](operacion/principios-tanque.md) |
| 7 | 🌍 Entornos de trabajo | Terrenos, pendientes y obstáculos. | [Abrir](operacion/entornos-tanque.md) |
| 8 | ⚖️ Reglamentos | Marco institucional público (Ejército, Ley 18.948). | [Abrir](reglamentos/reglamentos-tanque.md) |
| 9 | 🎮 Diseño de simulación | Variables de movilidad, ciclo y modos educativos. | [Abrir](simulacion/diseno-simulador-tanque.md) |
| 10 | 🧰 Recursos | Glosario, enlaces y diagramas. | [Abrir](recursos/recursos-tanque.md) |
| 11 | 🎯 Ejercicios | Autoevaluación con respuestas plegadas. | [Abrir](ejercicios/ejercicios-tanque.md) |
