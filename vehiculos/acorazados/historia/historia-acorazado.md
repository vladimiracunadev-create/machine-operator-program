...
resultados_aprendizaje:
  - "Explicar origen, evolución tecnológica, variantes representativas e impacto con vocabulario propio de Acorazados."
...
```mermaid
timeline
    title Evolucion publica del acorazado
    1860-1880 : Primeros buques de casco de hierro
    1890-1905 : Acorazados pre-dreadnought
    1906 : El HMS Dreadnought cambia el estandar
    1914-1918 : Gran uso durante la Primera Guerra Mundial
    1920-1940 : Grandes acorazados de la epoca
    1945-hoy : Retiro y conservacion como museos
```
...
- **Actividad:** Construye una línea de tiempo de Acorazados y explica cómo dos cambios históricos transformaron su función o su puesto de mando.
- **Evidencia:** Línea de tiempo comentada con cuatro hitos o más.
