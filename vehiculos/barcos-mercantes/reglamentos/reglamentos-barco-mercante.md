...
clase: 8
codigo: BARCOSMERCAN-08
curso: barcos-mercantes
titulo: "Reglamentos: Barcos mercantes (Chile)"
modalidad: "estudio de casos"
duracion_minutos: 60
nivel: introductorio
prerrequisito: BARCOSMERCAN-07
competencia: "cumplimiento_y_seguridad"
resultados_aprendizaje:
  - "Explicar ámbito, requisitos, seguridad, restricciones y aplicación en simulación con vocabulario propio de Barcos mercantes."
...
# ⚖️ Reglamentos: Barcos mercantes (Chile)

[🏠 Inicio](../../../README.md) · [🚢 Curso: Barcos mercantes](../README.md) · ⚖️ Reglamentos
...
| --- | --- | --- | --- |
| Matrícula de la nave | DL 2.222, Arts. 10 y 11 | Registro y nacionalidad chilena. | Estado documental de la nave. |
| Seguridad de la vida en el mar | SOLAS 1974 | Equipos y procedimientos de seguridad. | Chequeos de seguridad a bordo. |
| Prevención de la contaminación | MARPOL 73/78 | Gestión de residuos y descargas. | Reglas ambientales del escenario. |
| Formación y guardia | STCW 1978 | Titulación y turnos de guardia. | Roles de tripulación y guardias. |
...
- Mantener guardias de navegación según la titulación.
...
- Operación según el título del personal y la dotación mínima.
- Zonas de navegación y de puerto según la Autoridad Marítima.

## Notas para simulación

- El núcleo educativo son las reglas COLREG y la navegación segura.
- Modelar luces de navegación, prioridades y maniobras de puerto.
- Registrar cada norma usada en [`manuales/fuentes.md`](../../../manuales/fuentes.md).

## 🎓 Cierre de clase

- **Actividad:** Analiza dos casos de Barcos mercantes; localiza la fuente aplicable y separa obligación real, buena práctica y regla de simulación.
- **Evidencia:** Ficha normativa con decisión y fuente trazable.
...
[⬅️ Anterior: Entornos de trabajo](../operacion/entornos-barco-mercante.md) · [➡️ Siguiente: Diseño de simulación](../simulacion/diseno-simulador-barco-mercante.md)
