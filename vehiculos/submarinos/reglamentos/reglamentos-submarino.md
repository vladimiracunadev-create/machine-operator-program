...
clase: 8
codigo: SUBMARINOS-08
curso: submarinos
titulo: "Reglamentos: Submarinos (marco público)"
modalidad: "estudio de casos"
duracion_minutos: 60
nivel: introductorio
prerrequisito: SUBMARINOS-07
competencia: "cumplimiento_y_seguridad"
resultados_aprendizaje:
  - "Explicar ámbito, requisitos, seguridad, restricciones y aplicación en simulación con vocabulario propio de Submarinos."
...
# ⚖️ Reglamentos: Submarinos (marco público)
...
- Tipo de buque: submarino (buque de guerra sumergible).
- Marco institucional: normativa militar (en Chile, Armada de Chile, Ley
  18.948). No se rige por la Ley de Navegación mercante.

## Derecho internacional aplicable

- CONVEMAR (D.S. RREE 1.393/1997): en el mar territorial, los submarinos deben
  navegar en superficie y enarbolar su pabellón (Art. 20); régimen e inmunidad
  de buques de guerra (Arts. 29 a 32).

## Enfoque permitido en simulación

- Historia pública y evolución del submarino.
- Principios físicos: flotabilidad, lastre, presión, inmersión y emersión.
- Roles generales de tripulación a nivel divulgativo.

## Restricciones de contenido

- No documentar táctica, doctrina ni sistemas de combate reales.
- No incluir información clasificada o restringida.

## Notas para simulación

- Enfocar en física de flotabilidad y lastre, historia y seguridad.
...
¿Cómo ayuda **Ámbito, Derecho internacional aplicable, Enfoque permitido en simulación y Restricciones de contenido** a **interrumpir la cadena que podría producir exceso de profundidad, pérdida de control o colisión por conciencia situacional limitada**?

### Explicación razonada

La regla de seguridad debe conectarse con un mecanismo de daño. El riesgo «exceso de profundidad, pérdida de control o colisión por conciencia situacional limitada» se controla mediante límites, inspección, competencia y coordinación; cada medida corta una parte de la cadena causal. En una situación real prevalecen la autoridad aplicable y el manual vigente de Submarinos.
...
1. **Describir el daño:** explica cómo se llegaría a **exceso de profundidad, pérdida de control o colisión por conciencia situacional limitada** sin usar solo la palabra “peligro”.
...
4. **Resolver:** documenta por qué **coordinar velocidad, planos y lastre observando tendencia, no solo profundidad instantánea** es una decisión preventiva y verificable.

### Comprueba tu comprensión

1. ¿Qué mecanismo concreto conduce a **exceso de profundidad, pérdida de control o colisión por conciencia situacional limitada**?
...
- **Actividad:** Analiza dos casos de Submarinos; localiza la fuente aplicable y separa obligación real, buena práctica y regla de simulación.
- **Evidencia:** Ficha normativa con decisión y fuente trazable.
...
[⬅️ Anterior: Entornos de trabajo](../operacion/entornos-submarino.md) · [➡️ Siguiente: Diseño de simulación](../simulacion/diseno-simulador-submarino.md)
