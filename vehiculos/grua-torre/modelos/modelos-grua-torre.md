...
codigo: GRUATORRE-03
curso: grua-torre
titulo: "Modelos y variantes de la grúa torre"
modalidad: "comparativa guiada"
duracion_minutos: 60
nivel: introductorio
prerrequisito: GRUATORRE-02
competencia: "seleccion_de_configuracion"
resultados_aprendizaje:
  - "Explicar manejo, arquitectura de mandos y variables de simulación con vocabulario propio de Grúa torre."
...
- **Actividad:** Compara variantes de Grúa torre mediante los ejes «manejo, arquitectura de mandos y variables de simulación» y elige una para un caso de uso razonado.
- **Evidencia:** Matriz comparativa y decisión justificada.
