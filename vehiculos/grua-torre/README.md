...
| 3 | 🧩 Modelos y variantes | Que cambia entre modelos: manejo, mando y simulador. | [Abrir](modelos/modelos-grua-torre.md) |
| 4 | 🔧 Sistemas mecánicos | Mástil, pluma, contrapeso, carro, giro, momento, trepado. | [Abrir](operacion/sistemas-mecanicos-grua-torre.md) |
| 5 | 🎛️ Mandos e instrumentos | Cabina, radiomando, palancas y limitadores. | [Abrir](mandos/manual-mandos-grua-torre.md) |
| 6 | 🧪 Principios y operación | Equilibrio de momentos y fases de izaje. | [Abrir](operacion/principios-grua-torre.md) |
| 7 | 🌍 Entornos de trabajo | Obra en altura, ciudad densa, viento, montaje. | [Abrir](operacion/entornos-grua-torre.md) |
| 8 | ⚖️ Reglamentos | Marco chileno: seguridad laboral e izaje fijo. | [Abrir](reglamentos/reglamentos-grua-torre.md) |
| 9 | 🎮 Diseño de simulación | Variables, ciclo y modos de juego. | [Abrir](simulacion/diseno-simulador-grua-torre.md) |
| 10 | 🧰 Recursos | Glosario, enlaces y diagramas. | [Abrir](recursos/recursos-grua-torre.md) |
| 11 | 🎯 Ejercicios | Autoevaluación con respuestas plegadas. | [Abrir](ejercicios/ejercicios-grua-torre.md) |
...
[➡️ Empezar por la Clase 1: Historia](historia/historia-grua-torre.md)
