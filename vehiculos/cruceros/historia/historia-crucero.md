...
resultados_aprendizaje:
  - "Explicar origen, evolución tecnológica, variantes representativas e impacto con vocabulario propio de Cruceros."
...
```mermaid
timeline
    title Evolucion del buque de crucero
    1840-1900 : Transatlanticos de vapor y correo
    1900-1940 : Grandes paquebotes de lujo
    1912 : Hundimiento del Titanic y primer SOLAS
    1950-1970 : El avion desplaza al transatlantico de linea
    1970-2000 : Nace el crucero de ocio moderno
    2000-hoy : Megabuques diesel-electricos con pods
```
...
- **Actividad:** Construye una línea de tiempo de Cruceros y explica cómo dos cambios históricos transformaron su función o su puesto de mando.
- **Evidencia:** Línea de tiempo comentada con cuatro hitos o más.
