...
¿Cómo ayuda **Glosario específico, Diagrama de rendimiento en curva, Enlaces y fuentes y Guía de estudio aplicada** a **explicar con fuentes los términos unidad de potencia, caja secuencial, diferencial y neumáticos**?

### Explicación razonada

El vocabulario técnico organiza relaciones: unidad de potencia, caja secuencial, diferencial y neumáticos nombran partes distintas de una misma cadena funcional. Una fuente se usa para sostener una afirmación concreta —principio, límite, procedimiento o contexto— y debe distinguirse del manual particular de un fabricante o de una regla narrativa.
...
1. **Definir en contexto:** explica **unidad de potencia**, **caja secuencial**, **diferencial** y **neumáticos** por su función y relación.
...
4. **Reformular:** convierte una definición copiada en una explicación propia con un ejemplo de **Fórmula 1**.

### Comprueba tu comprensión

1. Explica la diferencia funcional entre **caja secuencial** y **diferencial** sin copiar una definición.
2. ¿Qué fuente respalda el principio «interacción entre carga aerodinámica, temperatura del neumático y balance del monoplaza» y cuál es su alcance?
