...
titulo: "Modelos y variantes del avión de combate"
modalidad: "comparativa guiada"
duracion_minutos: 60
nivel: introductorio
prerrequisito: AVIONESCOMBA-02
competencia: "seleccion_de_configuracion"
resultados_aprendizaje:
  - "Explicar manejo, arquitectura de mandos y variables de simulación con vocabulario propio de Aviones de combate."
...
- **Actividad:** Compara variantes de Aviones de combate mediante los ejes «manejo, arquitectura de mandos y variables de simulación» y elige una para un caso de uso razonado.
- **Evidencia:** Matriz comparativa y decisión justificada.
