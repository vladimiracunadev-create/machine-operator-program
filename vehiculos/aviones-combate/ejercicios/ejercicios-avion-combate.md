...
clase: 11
codigo: AVIONESCOMBA-11
curso: aviones-combate
titulo: "Ejercicios y autoevaluación del avión de combate"
modalidad: "evaluación auténtica"
duracion_minutos: 90
nivel: introductorio
prerrequisito: AVIONESCOMBA-10
competencia: "integracion_de_competencias"
resultados_aprendizaje:
  - "Explicar comprensión, aplicación y transferencia a la simulación con vocabulario propio de Aviones de combate."
...
Clase 4: [🔧 Sistemas mecánicos](../operacion/sistemas-mecanicos-avion-combate.md).
...
Clase 6: [🧪 Principios y operación](../operacion/principios-avion-combate.md).
...
Clase 8: [⚖️ Reglamentos](../reglamentos/reglamentos-avion-combate.md) y el
...
¿Cómo ayuda **Comprueba lo que recuerdas, Aplica: casos de operación, Lleva a la simulación y Guía de estudio aplicada** a **defender una solución integral para maniobra simulada de alta carga con combustible limitado**?

### Explicación razonada

La integración no consiste en repetir definiciones. Ante «maniobra simulada de alta carga con combustible limitado» hay que reconstruir la cadena motor → tobera → flujo → superficies y control de vuelo, aplicar el principio «intercambio entre energía cinética, altura, carga estructural y capacidad de giro», reconocer el riesgo y defender una decisión verificable: preservar margen de energía y carga antes de ordenar una maniobra.
...
1. **Diagnosticar:** reconstruye **motor → tobera → flujo → superficies y control de vuelo** ante **maniobra simulada de alta carga con combustible limitado**.
2. **Explicar:** aplica **intercambio entre energía cinética, altura, carga estructural y capacidad de giro** y cita el dato que sostiene la interpretación.
3. **Decidir:** propone **preservar margen de energía y carga antes de ordenar una maniobra** y compara una alternativa que sería menos segura o menos eficaz.
4. **Verificar:** define evidencia de éxito, condición de abandono y aprendizaje transferible a **caza ligero monomotor frente a interceptor bimotor**.

### Comprueba tu comprensión

1. ¿Cuál es tu diagnóstico causal de «maniobra simulada de alta carga con combustible limitado»?
2. ¿Qué alternativa a **preservar margen de energía y carga antes de ordenar una maniobra** considerarías y por qué ofrece menos margen?
...
- **Actividad:** Resuelve la autoevaluación de Aviones de combate y defiende una decisión en un escenario integrador sin consultar las respuestas.
- **Evidencia:** Respuestas justificadas y escenario final resuelto.
