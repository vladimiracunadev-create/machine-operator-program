...
| 3 | 🧩 Modelos y variantes | Que cambia entre modelos: manejo, mando y simulador. | [Abrir](modelos/modelos-estacion-espacial.md) |
| 4 | 🔧 Sistemas mecánicos | Módulos, paneles, soporte vital, acoplamiento, EVA. | [Abrir](operacion/sistemas-mecanicos-estacion-espacial.md) |
| 5 | 🎛️ Mandos e instrumentos | Centro de control, telemetría y estaciones de trabajo. | [Abrir](mandos/manual-mandos-estacion-espacial.md) |
| 6 | 🧪 Principios y operación | Microgravedad, órbita baja y fases de operación. | [Abrir](operacion/principios-estacion-espacial.md) |
| 7 | 🌍 Entornos de trabajo | Órbita baja, interior habitable y espacio abierto. | [Abrir](operacion/entornos-estacion-espacial.md) |
| 8 | ⚖️ Reglamentos | Acuerdo intergubernamental y tratados espaciales. | [Abrir](reglamentos/reglamentos-estacion-espacial.md) |
| 9 | 🎮 Diseño de simulación | Variables, ciclo y modos de juego. | [Abrir](simulacion/diseno-simulador-estacion-espacial.md) |
| 10 | 🧰 Recursos | Glosario, enlaces y diagramas. | [Abrir](recursos/recursos-estacion-espacial.md) |
| 11 | 🎯 Ejercicios | Autoevaluación con respuestas plegadas. | [Abrir](ejercicios/ejercicios-estacion-espacial.md) |
