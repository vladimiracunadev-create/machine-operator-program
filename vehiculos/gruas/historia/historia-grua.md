...
resultados_aprendizaje:
  - "Explicar origen, evolución tecnológica, variantes representativas e impacto con vocabulario propio de Grúas."
...
```mermaid
timeline
    title Evolucion de la grua
    Siglo VI a.C. : Gruas griegas con poleas y cabrestante
    Epoca romana : Polyspastos y rueda de andar humana
    Edad Media : Gruas de puerto y de catedral con rueda de ardilla
    Siglo XIX : Gruas de vapor y estructura de hierro
    1900-1950 : Motor de combustion y gruas sobre orugas
    1950-1980 : Hidraulica, pluma telescopica y gruas todo terreno
    1980-hoy : Electronica, LMI y gruas torre de gran altura
```
...
- **Actividad:** Construye una línea de tiempo de Grúas y explica cómo dos cambios históricos transformaron su función o su puesto de mando.
- **Evidencia:** Línea de tiempo comentada con cuatro hitos o más.
